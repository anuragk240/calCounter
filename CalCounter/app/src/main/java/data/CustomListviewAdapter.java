...
import com.example.suhail.calcounter.FoodItemsDetailActivity;
import com.example.suhail.calcounter.R;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        row.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(activity, FoodItemsDetailActivity.class);
